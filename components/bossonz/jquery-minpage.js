...
(function(factory) {
    ...
    Beautifier.prototype = {
        ...
        _goPage:function(ele) {
            var $goInput = ele.find("input"), str_page = $goInput.val();
            if (isNaN(str_page)) {
        ...
        _create:function() {
            var ele = this.element, that = this;
        ...
        _appendTo:function() {
            ...
            ddh += '<div class="pr">';
            if(this.pno==1 ){
            	 ddh += '<a href="#"  class="min-page-prev min-page-disable" data-page="' + this.prv + '">&lt;</a>';
            }else{
            	ddh += '<a href="#"  class="min-page-prev " data-page="' + this.prv + '">&lt;</a>';
            }
            
            ddh += '<span><input type="text" value="' + this.pno + '" class="min-page-now" data-now="' + this.pno + '"></span>', 
            ddh += "/" + '<span class="min-page-total" data-page="' + this.total + '">' + this.total + '</span>';
            if(this.pno==this.total){
            	ddh += '<a href="#" class="min-page-next min-page-disable" data-page="' + this.next + '">&gt;</a>';
            }else{
            	ddh += '<a href="#" class="min-page-next" data-page="' + this.next + '">&gt;</a>';
            }
